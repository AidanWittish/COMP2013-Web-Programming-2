...
function App() {
  ...
  return (
    ...
    <div className="main-container">
        ...
        <Card image="src\assets\images\3.jpg" location="US Virgin islands" name="Goa Resort" rating="3.5 ★" price="$485/night" badRating={true}/>
        ...
        <Card image="src\assets\images\6.jpg" location="Bermuda" name="Staniel Cay Hotel" rating="3.2 ★" price="$365/night" badRating={true}/>
    </div>
    </>
  );
}
